...
// Brand icons not available in lucide-react, drawn as simple glyphs.

export function Html5(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} {...props}>
      <path d="M4 3l1.6 17L12 22l6.4-2L20 3H4z" />
      <path d="M8 7.5h8M8.5 11h7M9 14.5h5.2M12 14.5V18" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function Css3(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} {...props}>
      <path d="M4 3l1.6 17L12 22l6.4-2L20 3H4z" />
      <path d="M8.5 7.5h7l-.5 3.5h-6l.3 3 4.7 1.2 4.7-1.2.4-4.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
